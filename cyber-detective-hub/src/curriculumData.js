...
export const CURRICULUM_DATA = [
  // ================= LEVEL 1 =================
  {
    ...
    handsOn: "Complete 5 Sandbox Exercises in two 5-step AI-Era loops: the first covering hardware, software, and how a program actually runs; the second covering networks, the web technology stack, and the AI-era development process itself.",
  ...
  },
  {
    ...
    handsOn: "Complete 5 Sandbox Exercises in two 5-step AI-Era loops: (1) Plan & Design: dark track specs, (2) Write Prompt: track width/height/color, (3) Review & Explain: ID vs Class selectors, (4) Test & Break: diagnosing drifting absolute cars, (5) Iterate & Improve: lane divider styles, (6) Plan & Design: car X/Y coordinates, (7) Write Prompt: centering player-car, (8) Review & Explain: absolute coordinate values, (9) Test & Break: display utility debugging, (10) Iterate & Improve: scoreboard flex layout.",
  ...
  },
  {
    ...
    handsOn: "Complete 4 small Sandbox Exercises building your own understanding of left/right lane guards and a full accelerate/brake/reverse speed system — speed capped at both ends (0 and 120), plus a reverse gear that kicks in once fully braked — each stated as a goal to reason through yourself, not a script to transcribe. Socratic Debugging — The Infinite Teleporting Bug: the tutor changes the boundary check from `carX > 35` to `carX >= -130`, causing the car to teleport off-screen. Trace what value `carX` actually reached and why the boundary guard failed to catch it. The session's Project Task is where it all comes together for real, on your own accumulated game.js — including two new on-screen buttons (▲ Accelerate / ▼ Brake) alongside Session 5's ◀/▶ — completing the milestone begun in Session 5: \"the car remembers itself, responds to you, and stays safe.\"",
