...
> **Always updated work logic, architectural to `PRJ_KNOWLEDGE.md` before ending a session.**

- Every time a new or updated requirement that changes software logic is completed, append details information to `PRJ_KNOWLEDGE.md`.
- Every time a new or updated technology, DB schema, architectural change is completed, append details information to `PRJ_KNOWLEDGE.md`.
- Never rely solely on chat history or ephemeral context for project continuity.
- Ensure the next assistant or developer can read `PRJ_KNOWLEDGE.md` to have the project knowlege.
